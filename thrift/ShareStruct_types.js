  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.attachtext = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.attachname = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Msg.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.msgtext = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.pushlishTime = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.device = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 11:
      if (ftype == Thrift.Type.STRING) {
        this.msgdesc = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
