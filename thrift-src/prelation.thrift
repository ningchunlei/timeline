...
service PRelationIFace{
       ...
       i32 addFans(1: string uid,2: string fansId) throws (1:Exception.EngineException error),
       list<string> getFollow(1:string uid,2:i32 start,3:i32 len) throws (1:Exception.EngineException error),
       list<string> getFans(1:string uid,2:i32 start,3:i32 len) throws (1:Exception.EngineException error)
}
